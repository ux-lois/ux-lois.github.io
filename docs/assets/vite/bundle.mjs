...
function Ge(t) {
  return this.selectAll(t == null ? Fe : De(typeof t == "function" ? t : Yt(t)));
}
function Ie(t) {
...
function Pe(t, e) {
  ...
  for (var o = i.length, s = new Array(o), a = new Array(o), c = new Array(o), l = 0; l < o; ++l) {
    ...
    n(u, f, g, A, pe, d, e);
    for (var D = 0, B = 0, bt, Nt; D < p; ++D)
      if (bt = g[D]) {
        for (D >= B && (B = D + 1); !(Nt = A[B]) && ++B < p; )
          ;
        bt._next = Nt || null;
      }
  }
...
function In(t, e) {
  var n = typeof t == "function" ? t : Ot(t), r = e == null ? Gn : typeof e == "function" ? e : _t(e);
  return this.select(function() {
...
var mr = ie(wr, "px, ", "px)", "deg)"), xr = ie(vr, ", ", ")", ")"), F = 0, I = 0, G = 0, oe = 1e3, et, V, nt = 0, C = 0, ot = 0, P = typeof performance == "object" && performance.now ? performance : Date, se = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function vt() {
...
function dt(t) {
  if (!F) {
    I && (I = clearTimeout(I));
    var e = t - C;
    e > 24 ? (t < 1 / 0 && (I = setTimeout(It, t - P.now() - ot)), G && (G = clearInterval(G))) : (G || (nt = P.now(), G = setInterval(kr, oe)), F = 1, se(It));
  }
}
function Vt(t, e, n) {
  var r = new rt();
...
function le(t, e) {
  var n;
  return (typeof e == "number" ? S : e instanceof O ? Dt : (n = O(e)) ? (e = n, Dt) : yr)(t, e);
}
function Dr(t) {
  return function() {
    this.removeAttribute(t);
...
function Xr(t, e) {
  ...
  return this.attrTween(t, typeof e == "function" ? (n.local ? Hr : qr)(n, r, xt(this, "attr." + t, e)) : e == null ? (n.local ? Gr : Dr)(n) : (n.local ? Vr : Ir)(n, r, e));
}
function Or(t, e) {
  return function(n) {
...
class Oi {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Xi;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
