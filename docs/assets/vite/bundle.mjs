...
function Pe(t, e) {
  ...
  for (var o = i.length, s = new Array(o), a = new Array(o), c = new Array(o), l = 0; l < o; ++l) {
    var u = r[l], f = i[l], h = f.length, d = Le(t.call(u, u && u.__data__, l, r)), p = d.length, g = a[l] = new Array(p), A = s[l] = new Array(p), pe = c[l] = new Array(h);
    n(u, f, g, A, pe, d, e);
...
function Cn(t) {
  return arguments.length ? this.each(t == null ? An : (typeof t == "function" ? $n : En)(t)) : this.node().innerHTML;
}
function Tn() {
...
function O(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = tr.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? Ct(e) : n === 3 ? new _(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? z(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? z(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = er.exec(t)) ? new _(e[1], e[2], e[3], 1) : (e = nr.exec(t)) ? new _(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = rr.exec(t)) ? z(e[1], e[2], e[3], e[4]) : (e = ir.exec(t)) ? z(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = or.exec(t)) ? Mt(e[1], e[2] / 100, e[3] / 100, 1) : (e = sr.exec(t)) ? Mt(e[1], e[2] / 100, e[3] / 100, e[4]) : At.hasOwnProperty(t) ? Ct(At[t]) : t === "transparent" ? new _(NaN, NaN, NaN, 0) : null;
}
function Ct(t) {
...
function ie(t, e, n, r) {
  ...
  function o(l, u, f, h, d, p) {
    if (l !== f || u !== h) {
      ...
      p.push({ i: g - 4, x: S(l, f) }, { i: g - 2, x: S(u, h) });
    } else
  ...
  return function(l, u) {
    ...
    return l = t(l), u = t(u), o(l.translateX, l.translateY, u.translateX, u.translateY, f, h), s(l.rotate, u.rotate, f, h), a(l.skewX, u.skewX, f, h), c(l.scaleX, l.scaleY, u.scaleX, u.scaleY, f, h), l = u = null, function(d) {
      for (var p = -1, g = h.length, A; ++p < g; )
        f[(A = h[p]).i] = A.x(d);
      return f.join("");
    };
  };
}
var mr = ie(wr, "px, ", "px)", "deg)"), xr = ie(vr, ", ", ")", ")"), F = 0, I = 0, D = 0, oe = 1e3, et, V, nt = 0, C = 0, ot = 0, P = typeof performance == "object" && performance.now ? performance : Date, se = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function vt() {
...
rt.prototype = ae.prototype = {
  ...
  restart: function(t, e, n) {
    ...
    n = (n == null ? vt() : +n) + (e == null ? 0 : +e), !this._next && V !== this && (V ? V._next = this : et = this, V = this), this._call = t, this._time = n, dt();
  },
  stop: function() {
...
function dt(t) {
  if (!F) {
    I && (I = clearTimeout(I));
    var e = t - C;
    e > 24 ? (t < 1 / 0 && (I = setTimeout(It, t - P.now() - ot)), D && (D = clearInterval(D))) : (D || (nt = P.now(), D = setInterval(kr, oe)), F = 1, se(It));
  }
}
function Vt(t, e, n) {
  var r = new rt();
...
function Xr(t, e) {
  ...
  return this.attrTween(t, typeof e == "function" ? (n.local ? Hr : qr)(n, r, xt(this, "attr." + t, e)) : e == null ? (n.local ? Dr : Gr)(n) : (n.local ? Vr : Ir)(n, r, e));
}
function Or(t, e) {
  return function(n) {
...
function li(t) {
  ...
  for (var r = this._groups, i = r.length, o = new Array(i), s = 0; s < i; ++s)
    for (var a = r[s], c = a.length, l = o[s] = new Array(c), u, f, h = 0; h < c; ++h)
      (u = a[h]) && (f = t.call(u, u.__data__, h, a)) && ("__data__" in u && (f.__data__ = u.__data__), l[h] = f, st(l[h], e, n, h, l, m(u, n)));
...
function ui(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var c = r[a], l = c.length, u, f = 0; f < l; ++f)
      if (u = c[f]) {
        for (var h = t.call(u, u.__data__, f, c), d, p = m(u, n), g = 0, A = h.length; g < A; ++g)
          (d = h[g]) && st(d, e, n, g, h, p);
        o.push(h), s.push(u);
      }
...
function Gi(t) {
  var e, n;
  t instanceof k ? (e = t._id, t = t._name) : (e = fe(), (n = Mi).time = vt(), t = t == null ? null : t + "");
...
const y = (t, e) => {
  ...
  const e = y("svg.gradient g", SVGGElement);
  ...
  const e = y("svg.gestalt g", SVGGElement);
  for (let n = 0; n < 5; n++)
    for (let r = 0; r < 4; r++)
...
class Pi {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Oi;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
