...
function Oe(t, e) {
  ...
  for (var o = i.length, s = new Array(o), a = new Array(o), l = new Array(o), c = 0; c < o; ++c) {
    var u = r[c], f = i[c], h = f.length, d = Le(t.call(u, u && u.__data__, c, r)), g = d.length, y = a[c] = new Array(g), E = s[c] = new Array(g), pe = l[c] = new Array(h);
    n(u, f, y, E, pe, d, e);
    for (var F = 0, B = 0, bt, Nt; F < g; ++F)
      if (bt = y[F]) {
        for (F >= B && (B = F + 1); !(Nt = E[B]) && ++B < g; )
          ;
        bt._next = Nt || null;
      }
  }
...
function $n(t) {
  return arguments.length ? this.each(t == null ? En : (typeof t == "function" ? An : Cn)(t)) : this.node().innerHTML;
}
function Rn() {
...
var Er = Pt("start", "end", "cancel", "interrupt"), Cr = [], le = 0, qt = 1, pt = 2, J = 3, Ht = 4, gt = 5, Q = 6;
...
function ui(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var l = r[a], c = l.length, u, f = 0; f < c; ++f)
      if (u = l[f]) {
        for (var h = t.call(u, u.__data__, f, l), d, g = w(u, n), y = 0, E = h.length; y < E; ++y)
...
class Ui {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : zi;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
...
const Ki = () => {
  Wi(), document.documentElement.style.setProperty(
    "--primary-color",
    "hsl(120, 100%, 25%)"
