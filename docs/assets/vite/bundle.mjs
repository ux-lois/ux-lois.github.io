...
var mr = ie(wr, "px, ", "px)", "deg)"), xr = ie(vr, ", ", ")", ")"), F = 0, I = 0, D = 0, oe = 1e3, et, V, nt = 0, $ = 0, ot = 0, P = typeof performance == "object" && performance.now ? performance : Date, se = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function vt() {
...
function ui(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var c = r[a], l = c.length, u, f = 0; f < l; ++f)
      if (u = c[f]) {
        for (var h = t.call(u, u.__data__, f, c), d, p = m(u, n), y = 0, A = h.length; y < A; ++y)
...
class Li {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Pi;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
