...
function Ae(t) {
  typeof t == "function" ? t = Ee(t) : t = Pt(t);
...
function Dn(t, e) {
  var n = typeof t == "function" ? t : Ot(t), r = e == null ? Vn : typeof e == "function" ? e : yt(e);
  return this.select(function() {
...
var H = 0.7, j = 1 / H, R = "\\s*([+-]?\\d+)\\s*", X = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", x = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", tr = /^#([0-9a-f]{3,8})$/, er = new RegExp(`^rgb\\(${R},${R},${R}\\)$`), nr = new RegExp(`^rgb\\(${x},${x},${x}\\)$`), rr = new RegExp(`^rgba\\(${R},${R},${R},${X}\\)$`), ir = new RegExp(`^rgba\\(${x},${x},${x},${X}\\)$`), or = new RegExp(`^hsl\\(${X},${x},${x}\\)$`), sr = new RegExp(`^hsla\\(${X},${x},${x},${X}\\)$`), Et = {
  aliceblue: 15792383,
...
var vr = ie(mr, "px, ", "px)", "deg)"), xr = ie(wr, ", ", ")", ")"), M = 0, D = 0, V = 0, oe = 1e3, et, I, nt = 0, $ = 0, ot = 0, P = typeof performance == "object" && performance.now ? performance : Date, se = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function wt() {
...
function dt(t) {
  if (!M) {
    D && (D = clearTimeout(D));
    var e = t - $;
    e > 24 ? (t < 1 / 0 && (D = setTimeout(Dt, t - P.now() - ot)), V && (V = clearInterval(V))) : (V || (nt = P.now(), V = setInterval(kr, oe)), M = 1, se(Dt));
  }
}
function It(t, e, n) {
  var r = new rt();
...
var Er = Xt("start", "end", "cancel", "interrupt"), Ar = [], ce = 0, qt = 1, pt = 2, J = 3, Ht = 4, gt = 5, Q = 6;
...
function le(t, e) {
  var n;
  return (typeof e == "number" ? S : e instanceof O ? Ft : (n = O(e)) ? (e = n, Ft) : _r)(t, e);
}
function Fr(t) {
  return function() {
    this.removeAttribute(t);
  ...
  for (let n = 0; n < 5; n++)
    for (let r = 0; r < 4; r++)
      t.createCircle(e, n * 20 + 100, r * 20 + 20, 5, {
        ...
        delay: 0,
        duration: 300
      }), t.createRect(e, 100 + 32, 12, 57, 37, 0.15);
}, he = {
  "02-fitts": [Vi],
  "01-purpose": [Di],
  "03-hick": [Ii],
...
class Bi {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Yi;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
