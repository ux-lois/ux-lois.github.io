...
function Xe(t, e, n, r, i, o, s) {
  ...
  for (a = 0; a < f; ++a)
    d = s.call(t, o[a], a, o) + "", (u = c.get(d)) ? (r[a] = u, u.__data__ = o[a], c.delete(d)) : n[a] = new Z(t, o[a]);
  for (a = 0; a < l; ++a)
...
function Pe(t, e) {
  ...
  var n = e ? Xe : Ge, r = this._parents, i = this._groups;
  typeof t != "function" && (t = He(t));
  for (var o = i.length, s = new Array(o), a = new Array(o), u = new Array(o), c = 0; c < o; ++c) {
    var l = r[c], f = i[c], h = f.length, d = Le(t.call(l, l && l.__data__, c, r)), p = d.length, g = a[c] = new Array(p), S = s[c] = new Array(p), pe = u[c] = new Array(h);
    n(l, f, g, S, pe, d, e);
    for (var I = 0, B = 0, bt, Nt; I < p; ++I)
      if (bt = g[I]) {
        for (I >= B && (B = I + 1); !(Nt = S[B]) && ++B < p; )
          ;
        bt._next = Nt || null;
      }
  }
...
function ze(t) {
  for (var e = t.selection ? t.selection() : t, n = this._groups, r = e._groups, i = n.length, o = r.length, s = Math.min(i, o), a = new Array(i), u = 0; u < s; ++u)
    for (var c = n[u], l = r[u], f = c.length, h = a[u] = new Array(f), d, p = 0; p < f; ++p)
      (d = c[p] || l[p]) && (h[p] = d);
  for (; u < i; ++u)
    a[u] = n[u];
...
function cn(t, e) {
  ...
  return this.each((e == null ? n.local ? rn : nn : typeof e == "function" ? n.local ? un : an : n.local ? sn : on)(n, e));
}
function zt(t) {
...
function Cn(t) {
  return arguments.length ? this.each(t == null ? Sn : (typeof t == "function" ? En : $n)(t)) : this.node().innerHTML;
}
function Tn() {
...
var G = 0.7, j = 1 / G, M = "\\s*([+-]?\\d+)\\s*", X = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", x = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", tr = /^#([0-9a-f]{3,8})$/, er = new RegExp(`^rgb\\(${M},${M},${M}\\)$`), nr = new RegExp(`^rgb\\(${x},${x},${x}\\)$`), rr = new RegExp(`^rgba\\(${M},${M},${M},${X}\\)$`), ir = new RegExp(`^rgba\\(${x},${x},${x},${X}\\)$`), or = new RegExp(`^hsl\\(${X},${x},${x}\\)$`), sr = new RegExp(`^hsla\\(${X},${x},${x},${X}\\)$`), St = {
  aliceblue: 15792383,
...
wt(_, lt, jt(Y, {
  ...
  darker(t) {
    return t = t == null ? G : Math.pow(G, t), new _(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new _(E(this.r), E(this.g), E(this.b), tt(this.opacity));
  },
  displayable() {
...
function te(t) {
  ...
  return a ? (e === o ? s = (n - r) / a + (n < r) * 6 : n === o ? s = (r - e) / a + 2 : s = (e - n) / a + 4, a /= u < 0.5 ? o + i : 2 - o - i, s *= 60) : a = u > 0 && u < 1 ? 0 : s, new w(s, a, u, t.opacity);
}
function fr(t, e, n, r) {
...
wt(w, fr, jt(Y, {
  ...
  darker(t) {
    return t = t == null ? G : Math.pow(G, t), new w(this.h, this.s, this.l * t, this.opacity);
  },
  rgb() {
  ...
  clamp() {
    return new w(Ft(this.h), U(this.s), U(this.l), tt(this.opacity));
  },
  displayable() {
...
const It = function t(e) {
  var n = pr(e);
  function r(i, o) {
    var s = n((i = lt(i)).r, (o = lt(o)).r), a = n(i.g, o.g), u = n(i.b, o.b), c = ne(i.opacity, o.opacity);
    return function(l) {
...
function yr(t, e) {
  var n = ft.lastIndex = ut.lastIndex = 0, r, i, o, s = -1, a = [], u = [];
  for (t = t + "", e = e + ""; (r = ft.exec(t)) && (i = ut.exec(e)); )
    (o = i.index) > n && (o = e.slice(n, o), a[s] ? a[s] += o : a[++s] = o), (r = r[0]) === (i = i[0]) ? a[s] ? a[s] += i : a[++s] = i : (a[++s] = null, u.push({ i: s, x: A(r, i) })), n = ut.lastIndex;
  return n < e.length && (o = e.slice(n), a[s] ? a[s] += o : a[++s] = o), a.length < 2 ? u[0] ? _r(u[0].x) : gr(e) : (e = u.length, function(c) {
    for (var l = 0, f; l < e; ++l)
      a[(f = u[l]).i] = f.x(c);
    return a.join("");
  });
...
function ie(t, e, n, r) {
  ...
  function o(c, l, f, h, d, p) {
    if (c !== f || l !== h) {
      var g = d.push("translate(", null, e, null, n);
      p.push({ i: g - 4, x: A(c, f) }, { i: g - 2, x: A(l, h) });
    } else
      (f || h) && d.push("translate(" + f + e + h + n);
  }
  function s(c, l, f, h) {
    c !== l ? (c - l > 180 ? l += 360 : l - c > 180 && (c += 360), h.push({ i: f.push(i(f) + "rotate(", null, r) - 2, x: A(c, l) })) : l && f.push(i(f) + "rotate(" + l + r);
  }
  function a(c, l, f, h) {
    c !== l ? h.push({ i: f.push(i(f) + "skewX(", null, r) - 2, x: A(c, l) }) : l && f.push(i(f) + "skewX(" + l + r);
  }
  ...
  return function(c, l) {
    ...
    return c = t(c), l = t(l), o(c.translateX, c.translateY, l.translateX, l.translateY, f, h), s(c.rotate, l.rotate, f, h), a(c.skewX, l.skewX, f, h), u(c.scaleX, c.scaleY, l.scaleX, l.scaleY, f, h), c = l = null, function(d) {
      for (var p = -1, g = h.length, S; ++p < g; )
        f[(S = h[p]).i] = S.x(d);
      return f.join("");
    };
  };
}
var mr = ie(wr, "px, ", "px)", "deg)"), xr = ie(vr, ", ", ")", ")"), F = 0, V = 0, D = 0, oe = 1e3, et, q, nt = 0, C = 0, ot = 0, P = typeof performance == "object" && performance.now ? performance : Date, se = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function vt() {
...
rt.prototype = ae.prototype = {
  ...
  restart: function(t, e, n) {
    ...
    n = (n == null ? vt() : +n) + (e == null ? 0 : +e), !this._next && q !== this && (q ? q._next = this : et = this, q = this), this._call = t, this._time = n, dt();
  },
  stop: function() {
...
var Sr = Xt("start", "end", "cancel", "interrupt"), $r = [], ue = 0, Ht = 1, pt = 2, J = 3, Gt = 4, gt = 5, Q = 6;
...
function Er(t, e, n) {
  ...
  function s(c) {
    ...
    for (l in r)
      if (d = r[l], d.name === n.name) {
        if (d.state === J)
          return qt(s);
        d.state === Gt ? (d.state = Q, d.timer.stop(), d.on.call("interrupt", t, t.__data__, d.index, d.group), delete r[l]) : +l < e && (d.state = Q, d.timer.stop(), d.on.call("cancel", t, t.__data__, d.index, d.group), delete r[l]);
      }
    if (qt(function() {
      n.state === J && (n.state = Gt, n.timer.restart(a, n.delay, n.time), a(c));
  ...
  function a(c) {
    for (var l = c < n.duration ? n.ease.call(null, c / n.duration) : (n.timer.restart(u), n.state = gt, 1), f = -1, h = i.length; ++f < h; )
      i[f].call(t, l);
    n.state === gt && (n.on.call("end", t, t.__data__, n.index, n.group), u());
  }
  function u() {
...
function Xr(t, e) {
  ...
  return this.attrTween(t, typeof e == "function" ? (n.local ? Gr : Hr)(n, r, xt(this, "attr." + t, e)) : e == null ? (n.local ? Dr : Ir)(n) : (n.local ? qr : Vr)(n, r, e));
}
function Or(t, e) {
  return function(n) {
...
function ci(t) {
  ...
  for (var r = this._groups, i = r.length, o = new Array(i), s = 0; s < i; ++s)
    for (var a = r[s], u = a.length, c = o[s] = new Array(u), l, f, h = 0; h < u; ++h)
      (l = a[h]) && (f = t.call(l, l.__data__, h, a)) && ("__data__" in l && (f.__data__ = l.__data__), c[h] = f, st(c[h], e, n, h, c, v(l, n)));
...
function li(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var u = r[a], c = u.length, l, f = 0; f < c; ++f)
      if (l = u[f]) {
        for (var h = t.call(l, l.__data__, f, u), d, p = v(l, n), g = 0, S = h.length; g < S; ++g)
...
function gi(t, e, n) {
  var r, i, o;
  return function() {
    var s = R(this, t), a = n(this), u = a + "";
    return a == null && (u = a = (this.style.removeProperty(t), R(this, t))), s === u ? null : s === r && u === i ? o : (i = u, o = e(r = s, a));
  };
}
function _i(t, e) {
  var n, r, i, o = "style." + e, s = "end." + o, a;
  return function() {
    var u = b(this, t), c = u.on, l = u.value[o] == null ? a || (a = le(e)) : void 0;
    (c !== n || i !== l) && (r = (n = c).copy()).on(s, i = l), u.on = r;
  };
}
function yi(t, e, n) {
  var r = (t += "") == "transform" ? mr : ce;
  return e == null ? this.styleTween(t, di(t, r)).on("end.style." + t, le(t)) : typeof e == "function" ? this.styleTween(t, gi(t, r, xt(this, "style." + t, e))).each(_i(this._id, t)) : this.styleTween(t, pi(t, r, e), n).on("end.style." + t, null);
}
function wi(t, e, n) {
  return function(r) {
...
H.prototype = {
  ...
  translate: function(t, e) {
    return t === 0 & e === 0 ? this : new H(this.k, this.x + this.k * t, this.y + this.k * e);
  },
  apply: function(t) {
...
const m = (t, e) => {
  ...
  const e = m("svg.hick g.choice-01", SVGGElement);
  t.createForm(
    e,
    "polygon",
  ...
  const n = m("svg.hick g.choice-02", SVGGElement);
  t.createForm(
    n,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const r = m("svg.hick g.choice-03", SVGGElement);
  t.createForm(
    r,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const i = m("svg.hick g.choice-04", SVGGElement);
  t.createForm(
    i,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const o = m("svg.hick g.choice-05", SVGGElement);
  t.createForm(
    o,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const s = m("svg.hick g.choice-06", SVGGElement);
  t.createForm(
    s,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
