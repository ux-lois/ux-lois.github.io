...
function yn(t, e) {
  return arguments.length > 1 ? this.each((e == null ? pn : typeof e == "function" ? _n : gn)(t, e)) : this.node()[t];
}
function Ut(t) {
...
function O(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = tr.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? Ct(e) : n === 3 ? new y(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? z(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? z(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = er.exec(t)) ? new y(e[1], e[2], e[3], 1) : (e = nr.exec(t)) ? new y(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = rr.exec(t)) ? z(e[1], e[2], e[3], e[4]) : (e = ir.exec(t)) ? z(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = or.exec(t)) ? Mt(e[1], e[2] / 100, e[3] / 100, 1) : (e = sr.exec(t)) ? Mt(e[1], e[2] / 100, e[3] / 100, e[4]) : At.hasOwnProperty(t) ? Ct(At[t]) : t === "transparent" ? new y(NaN, NaN, NaN, 0) : null;
}
function Ct(t) {
...
function lr(t) {
  return t instanceof Y || (t = O(t)), t ? (t = t.rgb(), new y(t.r, t.g, t.b, t.opacity)) : new y();
}
function ut(t, e, n, r) {
  return arguments.length === 1 ? lr(t) : new y(t, e, n, r ?? 1);
}
function y(t, e, n, r) {
...
wt(y, ut, jt(Y, {
  brighter(t) {
    return t = t == null ? j : Math.pow(j, t), new y(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  darker(t) {
    return t = t == null ? H : Math.pow(H, t), new y(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  rgb() {
    return this;
  },
  clamp() {
    return new y($(this.r), $(this.g), $(this.b), tt(this.opacity));
  },
  displayable() {
...
function yr(t, e) {
  ...
  return n < e.length && (o = e.slice(n), a[s] ? a[s] += o : a[++s] = o), a.length < 2 ? c[0] ? _r(c[0].x) : gr(e) : (e = c.length, function(l) {
    for (var u = 0, f; u < e; ++u)
      a[(f = c[u]).i] = f.x(l);
    return a.join("");
  });
...
function le(t, e) {
  var n;
  return (typeof e == "number" ? S : e instanceof O ? Gt : (n = O(e)) ? (e = n, Gt) : yr)(t, e);
}
function Gr(t) {
  return function() {
    this.removeAttribute(t);
...
function yi(t, e, n) {
  ...
  return e == null ? this.styleTween(t, di(t, r)).on("end.style." + t, ue(t)) : typeof e == "function" ? this.styleTween(t, gi(t, r, xt(this, "style." + t, e))).each(_i(this._id, t)) : this.styleTween(t, pi(t, r, e), n).on("end.style." + t, null);
}
function wi(t, e, n) {
  return function(r) {
...
const _ = (t, e) => {
  ...
  const e = _("svg.hick g.choice-01", SVGGElement);
  t.createForm(
    e,
    "polygon",
  ...
  const n = _("svg.hick g.choice-02", SVGGElement);
  t.createForm(
    n,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const r = _("svg.hick g.choice-03", SVGGElement);
  t.createForm(
    r,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const i = _("svg.hick g.choice-04", SVGGElement);
  t.createForm(
    i,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const o = _("svg.hick g.choice-05", SVGGElement);
  t.createForm(
    o,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const s = _("svg.hick g.choice-06", SVGGElement);
  t.createForm(
    s,
    "polygon",
    { points: "0,0 0,0 0,0 0,0" },
  ...
  const e = _("svg.jakob g.app-1", SVGGElement);
  t.createCircle(e, 40, 50, 35);
  const n = _("svg.jakob g.app-2", SVGGElement);
  t.createCircle(n, 40, 50, 35);
  const r = _("svg.jakob g.your-app", SVGGElement);
  t.createCircle(r, 40, 50, 35);
}, Hi = (t) => {
  const e = _("svg.gradient g", SVGGElement);
  ...
  const e = _("svg.gestalt g", SVGGElement);
  for (let n = 0; n < 10; n++)
    for (let r = 0; r < 5; r++)
      t.createCircle(e, n * 10, r * 10, 1);
}, he = {
  "02-fitts": [Di],
  "01-purpose": [Ii],
  "03-hick": [Vi],
