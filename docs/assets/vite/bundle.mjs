...
function it(t) {
  var e = t += "", n = e.indexOf(":");
  return n >= 0 && (e = t.slice(0, n)) !== "xmlns" && (t = t.slice(n + 1)), kt.hasOwnProperty(e) ? { space: kt[e], local: t } : t;
}
function we(t) {
  return function() {
...
function Pe(t, e, n, r, i, o, s) {
  var a, l, c = /* @__PURE__ */ new Map(), u = e.length, f = o.length, h = new Array(u), d;
  for (a = 0; a < u; ++a)
    (l = e[a]) && (h[a] = d = s.call(l, l.__data__, a, e) + "", c.has(d) ? i[a] = l : c.set(d, l));
  for (a = 0; a < f; ++a)
    d = s.call(t, o[a], a, o) + "", (l = c.get(d)) ? (r[a] = l, l.__data__ = o[a], c.delete(d)) : n[a] = new Z(t, o[a]);
  for (a = 0; a < u; ++a)
...
function Oe(t, e) {
  ...
  for (var o = i.length, s = new Array(o), a = new Array(o), l = new Array(o), c = 0; c < o; ++c) {
    var u = r[c], f = i[c], h = f.length, d = Le(t.call(u, u && u.__data__, c, r)), g = d.length, y = a[c] = new Array(g), C = s[c] = new Array(g), pe = l[c] = new Array(h);
    n(u, f, y, C, pe, d, e);
    for (var F = 0, B = 0, bt, Nt; F < g; ++F)
      if (bt = y[F]) {
        for (F >= B && (B = F + 1); !(Nt = C[B]) && ++B < g; )
          ;
        bt._next = Nt || null;
      }
  }
...
function ze(t) {
  for (var e = t.selection ? t.selection() : t, n = this._groups, r = e._groups, i = n.length, o = r.length, s = Math.min(i, o), a = new Array(i), l = 0; l < s; ++l)
    for (var c = n[l], u = r[l], f = c.length, h = a[l] = new Array(f), d, g = 0; g < f; ++g)
      (d = c[g] || u[g]) && (h[g] = d);
  for (; l < i; ++l)
    a[l] = n[l];
...
function kn(t) {
  return arguments.length ? this.each(t == null ? bn : (typeof t == "function" ? Sn : Nn)(t)) : this.node().textContent;
}
function Cn() {
  this.innerHTML = "";
}
...
function X(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = tr.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? $t(e) : n === 3 ? new _(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? z(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? z(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = er.exec(t)) ? new _(e[1], e[2], e[3], 1) : (e = nr.exec(t)) ? new _(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = rr.exec(t)) ? z(e[1], e[2], e[3], e[4]) : (e = ir.exec(t)) ? z(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = or.exec(t)) ? Gt(e[1], e[2] / 100, e[3] / 100, 1) : (e = sr.exec(t)) ? Gt(e[1], e[2] / 100, e[3] / 100, e[4]) : Ct.hasOwnProperty(t) ? $t(Ct[t]) : t === "transparent" ? new _(NaN, NaN, NaN, 0) : null;
}
function $t(t) {
...
function _r(t, e) {
  ...
  for (t = t + "", e = e + ""; (r = ft.exec(t)) && (i = lt.exec(e)); )
    (o = i.index) > n && (o = e.slice(n, o), a[s] ? a[s] += o : a[++s] = o), (r = r[0]) === (i = i[0]) ? a[s] ? a[s] += i : a[++s] = i : (a[++s] = null, l.push({ i: s, x: k(r, i) })), n = lt.lastIndex;
  return n < e.length && (o = e.slice(n), a[s] ? a[s] += o : a[++s] = o), a.length < 2 ? l[0] ? yr(l[0].x) : gr(e) : (e = l.length, function(c) {
    for (var u = 0, f; u < e; ++u)
      a[(f = l[u]).i] = f.x(c);
    return a.join("");
  });
...
function ie(t, e, n, r) {
  ...
  function o(c, u, f, h, d, g) {
    if (c !== f || u !== h) {
      var y = d.push("translate(", null, e, null, n);
      g.push({ i: y - 4, x: k(c, f) }, { i: y - 2, x: k(u, h) });
    } else
      (f || h) && d.push("translate(" + f + e + h + n);
  }
  function s(c, u, f, h) {
    c !== u ? (c - u > 180 ? u += 360 : u - c > 180 && (c += 360), h.push({ i: f.push(i(f) + "rotate(", null, r) - 2, x: k(c, u) })) : u && f.push(i(f) + "rotate(" + u + r);
  }
  function a(c, u, f, h) {
    c !== u ? h.push({ i: f.push(i(f) + "skewX(", null, r) - 2, x: k(c, u) }) : u && f.push(i(f) + "skewX(" + u + r);
  }
  ...
  return function(c, u) {
    var f = [], h = [];
    return c = t(c), u = t(u), o(c.translateX, c.translateY, u.translateX, u.translateY, f, h), s(c.rotate, u.rotate, f, h), a(c.skewX, u.skewX, f, h), l(c.scaleX, c.scaleY, u.scaleX, u.scaleY, f, h), c = u = null, function(d) {
      for (var g = -1, y = h.length, C; ++g < y; )
        f[(C = h[g]).i] = C.x(d);
      return f.join("");
    };
  };
...
function dt(t) {
  if (!M) {
    D && (D = clearTimeout(D));
    var e = t - $;
    e > 24 ? (t < 1 / 0 && (D = setTimeout(Dt, t - O.now() - ot)), V && (V = clearInterval(V))) : (V || (nt = O.now(), V = setInterval(Sr, oe)), M = 1, se(Dt));
  }
}
function It(t, e, n) {
  var r = new rt();
...
var Cr = Pt("start", "end", "cancel", "interrupt"), Er = [], le = 0, qt = 1, pt = 2, J = 3, Ht = 4, gt = 5, Q = 6;
...
function Ar(t, e, n) {
  ...
  function a(c) {
    for (var u = c < n.duration ? n.ease.call(null, c / n.duration) : (n.timer.restart(l), n.state = gt, 1), f = -1, h = i.length; ++f < h; )
      i[f].call(t, u);
    n.state === gt && (n.on.call("end", t, t.__data__, n.index, n.group), l());
  }
  function l() {
...
function ce(t, e) {
  var n;
  return (typeof e == "number" ? k : e instanceof X ? Ft : (n = X(e)) ? (e = n, Ft) : _r)(t, e);
}
function Fr(t) {
  return function() {
    this.removeAttribute(t);
...
function ri(t) {
  ...
  for (var e = this._groups, n = t._groups, r = e.length, i = n.length, o = Math.min(r, i), s = new Array(r), a = 0; a < o; ++a)
    for (var l = e[a], c = n[a], u = l.length, f = s[a] = new Array(u), h, d = 0; d < u; ++d)
      (h = l[d] || c[d]) && (f[d] = h);
  for (; a < r; ++a)
    s[a] = e[a];
  return new S(s, this._parents, this._name, this._id);
}
function ii(t) {
...
function ci(t) {
  ...
  return new S(o, this._parents, e, n);
}
function ui(t) {
  var e = this._name, n = this._id;
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var l = r[a], c = l.length, u, f = 0; f < c; ++f)
      if (u = l[f]) {
        for (var h = t.call(u, u.__data__, f, l), d, g = w(u, n), y = 0, C = h.length; y < C; ++y)
          (d = h[y]) && st(d, e, n, y, h, g);
        o.push(h), s.push(u);
      }
  return new S(o, s, e, n);
}
...
function Fi(t) {
  var e, n;
  t instanceof S ? (e = t._id, t = t._name) : (e = fe(), (n = Gi).time = vt(), t = t == null ? null : t + "");
...
const p = (t, e) => {
  ...
  for (let n = 0; n < 10; n++)
    t.createCircle(e, 50 + n * 20, 10, 5, { class: n >= 5 ? "empty" : "full" });
  for (let n = 0; n < 10; n++)
    t.createCircle(e, 50 + n * 20, 50, 5, { class: n % 2 ? "empty" : "full" });
  for (let n = 0; n < 10; n++)
    t.createCircle(e, 50 + n * 20, 90, 5, { class: n < 5 ? "empty" : "full" });
}, he = {
  fitts: [Vi],
  purpose: [Di],
  hick: [Ii],
...
class Ki {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Ui;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
