...
function Oe(t, e) {
  ...
  for (var o = i.length, s = new Array(o), a = new Array(o), l = new Array(o), c = 0; c < o; ++c) {
    var u = r[c], f = i[c], h = f.length, p = Le(t.call(u, u && u.__data__, c, r)), g = p.length, y = a[c] = new Array(g), k = s[c] = new Array(g), de = l[c] = new Array(h);
    n(u, f, y, k, de, p, e);
    for (var F = 0, B = 0, bt, Nt; F < g; ++F)
      if (bt = y[F]) {
        for (F >= B && (B = F + 1); !(Nt = k[B]) && ++B < g; )
          ;
        bt._next = Nt || null;
      }
  }
...
function ze(t) {
  for (var e = t.selection ? t.selection() : t, n = this._groups, r = e._groups, i = n.length, o = r.length, s = Math.min(i, o), a = new Array(i), l = 0; l < s; ++l)
    for (var c = n[l], u = r[l], f = c.length, h = a[l] = new Array(f), p, g = 0; g < f; ++g)
      (p = c[g] || u[g]) && (h[g] = p);
  for (; l < i; ++l)
    a[l] = n[l];
...
function _n(t, e) {
  return arguments.length > 1 ? this.each((e == null ? dn : typeof e == "function" ? yn : gn)(t, e)) : this.node()[t];
}
function Ut(t) {
...
function X(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = tr.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? $t(e) : n === 3 ? new _(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? z(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? z(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = er.exec(t)) ? new _(e[1], e[2], e[3], 1) : (e = nr.exec(t)) ? new _(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = rr.exec(t)) ? z(e[1], e[2], e[3], e[4]) : (e = ir.exec(t)) ? z(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = or.exec(t)) ? Gt(e[1], e[2] / 100, e[3] / 100, 1) : (e = sr.exec(t)) ? Gt(e[1], e[2] / 100, e[3] / 100, e[4]) : kt.hasOwnProperty(t) ? $t(kt[t]) : t === "transparent" ? new _(NaN, NaN, NaN, 0) : null;
}
function $t(t) {
...
function ie(t, e, n, r) {
  ...
  function o(c, u, f, h, p, g) {
    if (c !== f || u !== h) {
      var y = p.push("translate(", null, e, null, n);
      g.push({ i: y - 4, x: S(c, f) }, { i: y - 2, x: S(u, h) });
    } else
...
function pt(t) {
  if (!M) {
    D && (D = clearTimeout(D));
    var e = t - $;
    e > 24 ? (t < 1 / 0 && (D = setTimeout(Dt, t - O.now() - ot)), V && (V = clearInterval(V))) : (V || (nt = O.now(), V = setInterval(Cr, oe)), M = 1, se(Dt));
  }
}
function It(t, e, n) {
  var r = new rt();
...
var kr = Pt("start", "end", "cancel", "interrupt"), Er = [], le = 0, qt = 1, dt = 2, J = 3, Ht = 4, gt = 5, Q = 6;
...
function ui(t) {
  ...
  for (var r = this._groups, i = r.length, o = [], s = [], a = 0; a < i; ++a)
    for (var l = r[a], c = l.length, u, f = 0; f < c; ++f)
      if (u = l[f]) {
        for (var h = t.call(u, u.__data__, f, l), p, g = w(u, n), y = 0, k = h.length; y < k; ++y)
          (p = h[y]) && st(p, e, n, y, h, g);
        o.push(h), s.push(u);
      }
...
function _i(t, e, n) {
  ...
  return e == null ? this.styleTween(t, pi(t, r)).on("end.style." + t, ue(t)) : typeof e == "function" ? this.styleTween(t, gi(t, r, xt(this, "style." + t, e))).each(yi(this._id, t)) : this.styleTween(t, di(t, r, e), n).on("end.style." + t, null);
}
function mi(t, e, n) {
  return function(r) {
...
class Wi {
  ...
  initSvg() {
    const e = this.svgName ? he[this.svgName] : Ki;
    if (e !== void 0)
      for (const n of e)
        n(this);
  }
...
const Ji = () => {
  Qi(), document.documentElement.style.setProperty(
    "--primary-color",
    "hsl(120, 100%, 25%)"
